%-----------------------------------------------------------------------
% Job saved on 30-Jun-2024 14:42:14 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7771)
% cfg_basicio BasicIO - Unknown
%-----------------------------------------------------------------------
matlabbatch{1}.spm.meeg.convert.dataset = {'C:\Users\nicol\Desktop\Masters\Semester 2\NMDA\EEGAnalysis\Preprocess\subject1.bdf'};
...
matlabbatch{2}.spm.meeg.preproc.montage.mode.write.montspec.montage.montagefile = {'C:\Users\nicol\Desktop\Masters\Semester 2\NMDA\EEGAnalysis\Preprocess\PreProcMat\avref_eog.mat'};
...
matlabbatch{3}.spm.meeg.preproc.prepare.task{1}.loadeegsens.eegsens = {'C:\Users\nicol\Desktop\Masters\Semester 2\NMDA\EEGAnalysis\Preprocess\sensors.pol'};
...
matlabbatch{7}.spm.meeg.preproc.epoch.trialchoice.trlfile = {'C:\Users\nicol\Desktop\Masters\Semester 2\NMDA\EEGAnalysis\Preprocess\PreProcMat\trialdef.mat'};
...
matlabbatch{9}.spm.meeg.averaging.average.plv = true;
